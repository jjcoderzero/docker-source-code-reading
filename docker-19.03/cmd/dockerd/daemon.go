...
import (
	...
	"docker-19.03/api"
	apiserver "docker-19.03/api/server"
	buildbackend "docker-19.03/api/server/backend/build"
	"docker-19.03/api/server/middleware"
	"docker-19.03/api/server/router"
	"docker-19.03/api/server/router/build"
	checkpointrouter "docker-19.03/api/server/router/checkpoint"
	"docker-19.03/api/server/router/container"
	distributionrouter "docker-19.03/api/server/router/distribution"
	grpcrouter "docker-19.03/api/server/router/grpc"
	"docker-19.03/api/server/router/image"
	"docker-19.03/api/server/router/network"
	pluginrouter "docker-19.03/api/server/router/plugin"
	sessionrouter "docker-19.03/api/server/router/session"
	swarmrouter "docker-19.03/api/server/router/swarm"
	systemrouter "docker-19.03/api/server/router/system"
	"docker-19.03/api/server/router/volume"
	buildkit "docker-19.03/builder/builder-next"
	"docker-19.03/builder/dockerfile"
	"docker-19.03/builder/fscache"
	"docker-19.03/cli/debug"
	"docker-19.03/daemon"
	"docker-19.03/daemon/cluster"
	"docker-19.03/daemon/config"
	"docker-19.03/daemon/listeners"
	"docker-19.03/dockerversion"
	"docker-19.03/libcontainerd/supervisor"
	dopts "docker-19.03/opts"
	"docker-19.03/pkg/authorization"
	"docker-19.03/pkg/homedir"
	"docker-19.03/pkg/jsonmessage"
	"docker-19.03/pkg/pidfile"
	"docker-19.03/pkg/plugingetter"
	"docker-19.03/pkg/signal"
	"docker-19.03/pkg/system"
	"docker-19.03/plugin"
	"docker-19.03/rootless"
	"docker-19.03/runconfig"
...
type DaemonCli struct {
	*config.Config
	...
	d               *daemon.Daemon
	authzMiddleware *authorization.Middleware // authzMiddleware能够动态地重新加载授权插件
}

// NewDaemonCli返回一个daemon CLI
