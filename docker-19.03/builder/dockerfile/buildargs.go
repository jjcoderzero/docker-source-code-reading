package dockerfile // import "docker-19.03/builder/dockerfile"

import (
	"fmt"
	"io"

	"docker-19.03/runconfig/opts"
)

// builtinAllowedBuildArgs是内置允许构建参数的列表，这些参数被认为是透明的，并被排除在镜像历史记录之外。在dispatchers.go中实现历史过滤
