...
import (
	...
	"docker-19.03/buildkit/executor"
	"docker-19.03/buildkit/exporter"
	localexporter "docker-19.03/buildkit/exporter/local"
	tarexporter "docker-19.03/buildkit/exporter/tar"
	"docker-19.03/buildkit/frontend"
	gw "docker-19.03/buildkit/frontend/gateway/client"
	"docker-19.03/buildkit/session"
	"docker-19.03/buildkit/snapshot"
	"docker-19.03/buildkit/solver"
	"docker-19.03/buildkit/solver/llbsolver/ops"
	"docker-19.03/buildkit/solver/pb"
	"docker-19.03/buildkit/source"
	"docker-19.03/buildkit/source/git"
	"docker-19.03/buildkit/source/http"
	"docker-19.03/buildkit/source/local"
	"docker-19.03/buildkit/util/contentutil"
	"docker-19.03/buildkit/util/progress"
	"docker-19.03/distribution"
	distmetadata "docker-19.03/distribution/metadata"
	"docker-19.03/distribution/xfer"
	"docker-19.03/image"
	"docker-19.03/layer"
	pkgprogress "docker-19.03/pkg/progress"
