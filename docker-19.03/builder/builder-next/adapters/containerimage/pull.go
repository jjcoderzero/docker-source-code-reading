...
import (
	...
	"docker-19.03/buildkit/session/auth"
	"docker-19.03/buildkit/source"
	"docker-19.03/buildkit/util/flightcontrol"
	"docker-19.03/buildkit/util/imageutil"
	"docker-19.03/buildkit/util/progress"
	"docker-19.03/buildkit/util/resolver"
	"docker-19.03/buildkit/util/tracing"
	"docker-19.03/distribution"
	"docker-19.03/distribution/metadata"
	"docker-19.03/distribution/xfer"
	"docker-19.03/image"
	"docker-19.03/layer"
	pkgprogress "docker-19.03/pkg/progress"
	"docker-19.03/reference"
...
// resolveModeToString is the equivalent of docker-19.03/buildkit/solver/llb.ResolveMode.String()
