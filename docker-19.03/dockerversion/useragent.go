package dockerversion // import "docker-19.03/dockerversion"
...
import (
	...
	"docker-19.03/pkg/parsers/kernel"
	"docker-19.03/pkg/useragent"
)

type UAStringKey struct{} // 在net/context结构中，UAStringKey用作用户代理字符串的键类型
